...
class CaloriesFormPage(MethodView):
    ...
    def post(self):
        ...
        calorie = Calorie(weight=float(calories_form.weight.data), height=float(calories_form.height.data), age=float(calories_form.age.data), temperature=temperature)
...
class CaloriesForm(Form):
    ...
    city = StringField("City: ", default='santa barbara')
